...
const FlashCard = ({question, answer, toggle}) => {
    return (
        <>
            <div 
                className="min-h-40 max-w-3xl bg-white m-2 border-slate-100 rounded-lg hover:scale-103 ease-in-out duration-150 cursor-pointer border-1"
                onClick={toggle}
            > 
